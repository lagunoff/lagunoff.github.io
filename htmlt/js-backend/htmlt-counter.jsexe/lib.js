...
function h$base_fillStat(fs, b, off) {
    ...
    h$base_store_field_number(b, off, 12, 4, fs.mode);
    h$base_store_field_number(b, off, 16, 4, fs.nlink);
    h$base_store_field_number(b, off, 20, 4, fs.uid);
    h$base_store_field_number(b, off, 24, 4, fs.gid);
    h$base_store_field_number(b, off, 28, 4, fs.rdev);
    h$base_store_field_number(b, off, 40, 8, fs.size);
    h$base_store_field_number(b, off, 48, 4, fs.blksize);
    h$base_store_field_number(b, off, 52, 4, fs.blocks);
    h$base_store_field_number(b, off, 104, 8, fs.ino);
    var atimeS = Math.floor(fs.atimeMs/1000);
    var atimeNs = (fs.atimeMs/1000 - atimeS) * 1000000000;
    h$base_store_field_number_2(b, off, 56, 8, atimeS, atimeNs);
    var mtimeS = Math.floor(fs.mtimeMs/1000);
    var mtimeNs = (fs.mtimeMs/1000 - mtimeS) * 1000000000;
    h$base_store_field_number_2(b, off, 72, 8, mtimeS, mtimeNs);
    var ctimeS = Math.floor(fs.ctimeMs/1000);
    var ctimeNs = (fs.ctimeMs/1000 - ctimeS) * 1000000000;
    h$base_store_field_number_2(b, off, 88, 8, ctimeS, ctimeNs);
}
...
function h$base_return_field(ptr, ptr_off, field_off, field_size) {
    ...
    if(field_size === 4) {
        ...
        { h$ret1 = (ptr.i3[(ptr_off>>2) + (field_off>>2)+1]); return (ptr.i3[(ptr_off>>2) + (field_off>>2)]); };
    } else {
        throw new Error("unsupported field size: " + field_size);
    }
}
...
function h$makeCallbackApply(n, f, extraArgs, fun) {
  ...
  if(n === 1) {
    c = function(x) {
      var args = extraArgs.slice(0);
      var action = (h$c2(h$ap1_e,(fun),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (x))))));
      args.unshift(action);
      return f.apply(this, args);
    }
  } else if (n === 2) {
    c = function(x,y) {
      var args = extraArgs.slice(0);
      var action = (h$c3(h$ap2_e,(fun),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (x)))),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (y))))));
      args.unshift(action);
      return f.apply(this, args);
    }
  } else if (n === 3) {
    c = function(x,y,z) {
      var args = extraArgs.slice(0);
      var action = (h$c2(h$ap1_e,((h$c3(h$ap2_e,(fun),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (x)))),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (y))))))),((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (z))))));
      args.unshift(action);
      return f.apply(this, args);
    }
  } else {
...
function h$rts_eval(action, unbox) {
  return new Promise((accept, reject) =>
    h$run((h$c4(h$ap3_e, (h$baseZCGHCziJSziPrimziresolveIO), (x => { accept(unbox(x))}), (e => { reject(new h$HaskellException(e))}), (action))))
  );
}
function h$rts_eval_sync(closure, unbox) {
  var res, status = 0;
  try {
  h$runSync((h$c4(h$ap3_e, (h$baseZCGHCziJSziPrimziresolveIO), ((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (x => { status = 1; res = unbox(x); })))), ((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (e => { status = 2; res = new h$HaskellException(e); })))), (closure))), false);
...
function h$rts_toIO(x) {
  return (h$c2(h$ap1_e,(h$baseZCGHCziJSziPrimzitoIO),(x)));
}
...
function h$toHsListJSVal(arr) {
    var r = h$ghczmprimZCGHCziTypesziZMZN;
    for(var i=arr.length-1;i>=0;i--) {
 r = (h$c2(h$ghczmprimZCGHCziTypesziZC_con_e, ((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (arr[i])))), (r)));
    }
    return r;
}
...
function h$throwJSException(e) {
  ...
  var someE = (h$c2(h$baseZCGHCziExceptionziTypeziSomeException_con_e,(h$baseZCGHCziJSziPrimzizdfExceptionJSException),((h$c2(h$baseZCGHCziJSziPrimziJSException_con_e,((h$c1(h$baseZCGHCziJSziPrimziJSVal_con_e, (e)))),(h$toHsString(strVal)))))));
...
function h$runSyncReturn(a, cont) {
  var t = new h$Thread();
  var aa = (h$c2(h$ap1_e,(h$baseZCGHCziJSziPrimziInternalzisetCurrentThreadResultValue),(a)));
